...
# I want to subset the rse_gene object to only those columns which overlap between
# colData(rse_gene)$genoSample and vcf_samp. Lucky for me, all of the sample IDs
# in rse_gene are present in vcf_samp.

# table(rse_gene$genoSample %in% vcf_samp)
