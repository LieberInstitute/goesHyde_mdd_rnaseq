...
norm_exp <- read.delim(text = gsub("#", "", readLines("/dcl01/lieber/ajaffe/lab/goesHyde_mdd_rnaseq/predixcan_pipeline/processed-data/01_get_inv_quantile_norm/goesHyde_mdd_rnaseq_Amygdala.expression.bed.gz")), header = TRUE, check.names = FALSE, sep = "")
...
write.table(norm_exp_transpose, file = "/dcl01/lieber/ajaffe/lab/goesHyde_mdd_rnaseq/predixcan_pipeline/processed-data/02_prep_inputs/transformed_expression.txt", sep = "\t",
            row.names = TRUE)
