...
message("\n ***** Read in genotypes *****")
## read in genotypes
newbfile = here("genotype_data",
                "goesHyde_mdd_Genotypes_maf01_geno10_hwe1e6")
...
snpMap$name = NA
snpMap$name[snpMap$Type != "SNV"] = rs$name[match(paste0("chr", snpMap$CHR, ":", snpMap$POS)[snpMap$Type != "SNV"],
...
message("All genoSamples in mds: ",
        all(pd_genoSamples$genoSample %in%  mds$genoSample))
mds$BrNum <-
  pd_genoSamples$BrNum[match(mds$genoSample, pd_genoSamples$genoSample)]
