...
# if(FALSE){
    opt <- list('organism' = 'hg38',
        'maindir' = '/dcl01/lieber/ajaffe/lab/goesHyde_mdd_rnaseq/preprocessed_data',
        'experiment' = 'goesHyde',
        'prefix' = 'MDD',
        'paired' = TRUE,
		'stranded' = 'reverse',
...
## add phenodata
pd = read.csv("samples_phenodata.csv", row.names=1)
stopifnot(identical(as.character(pd$RNum), metrics$SAMPLE_ID))
metrics = cbind(metrics, pd[,2:9])
