...
load(here("genotype_data", "goesHyde_bipolarMdd_Genotypes.rda"), verbose = TRUE) # snp, snpMap & mds
...
all(has_genotype) ## All BrNum are in data

rse_gene <- rse_gene[, regInd]
# rse_exon <- rse_exon[, region_idx]
# rse_jxn <- rse_jxn[, region_idx]
# rse_tx <- rse_tx[, region_idx]
...
table(allEqtlFDR01$Type)
# Exon     Gene      Jxn       Tx 
# 14692485  2338029  8931780  3198436 
amyg <- allEqtlFDR01
...
pdf(here("eqtl","genomewide","plots","amyg_top_eqtl_adj.pdf"), h = 6, w = 10)
