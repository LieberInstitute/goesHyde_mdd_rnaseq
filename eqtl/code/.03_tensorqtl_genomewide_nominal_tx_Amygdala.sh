...
#$ -N tensorqtl_genomewide_nominal_tx_Amygdala
#$ -o logs/03_tensorqtl_genomewide_nominal_tx_Amygdala.txt
#$ -e logs/03_tensorqtl_genomewide_nominal_tx_Amygdala.txt
#$ -m e
...
## Run Python
python 03_tensorqtl_genomewide_nominal.py tx_Amygdala
echo "**** Job ends ****"
date
