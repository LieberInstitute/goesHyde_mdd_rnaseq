...
#$ -N tensorqtl_genomewide_nominal_exon_sACC
#$ -o logs/03_tensorqtl_genomewide_nominal_exon_sACC.txt
#$ -e logs/03_tensorqtl_genomewide_nominal_exon_sACC.txt
#$ -m e
...
## Run Python
python 03_tensorqtl_genomewide_nominal.py exon_sACC
echo "**** Job ends ****"
date
