...
#$ -N tensorqtl_genomewide_nominal_jxn_Amygdala
#$ -o logs/03_tensorqtl_genomewide_nominal_jxn_Amygdala.txt
#$ -e logs/03_tensorqtl_genomewide_nominal_jxn_Amygdala.txt
#$ -m e
...
## Run Python
python 03_tensorqtl_genomewide_nominal.py jxn_Amygdala
echo "**** Job ends ****"
date
