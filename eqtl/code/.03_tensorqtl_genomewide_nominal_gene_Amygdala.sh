...
#$ -N tensorqtl_genomewide_nominal_gene_Amygdala
#$ -o logs/03_tensorqtl_genomewide_nominal_gene_Amygdala.txt
#$ -e logs/03_tensorqtl_genomewide_nominal_gene_Amygdala.txt
#$ -m e
