...
#$ -N tensorqtl_genomewide_nominal_jxn_sACC
#$ -o logs/03_tensorqtl_genomewide_nominal_jxn_sACC.txt
#$ -e logs/03_tensorqtl_genomewide_nominal_jxn_sACC.txt
#$ -m e
...
## Run Python
python 03_tensorqtl_genomewide_nominal.py jxn_sACC
echo "**** Job ends ****"
date
