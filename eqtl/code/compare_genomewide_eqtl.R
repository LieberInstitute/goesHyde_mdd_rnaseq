...
# [1] 9079
length(intersect(geneEqtl_matrix$snps, cisEqtl_tensor$gene_amyg$variant_id))
# [1] 305086
...
# [1] 24470
length(unique(cisEqtl_tensor$gene_amyg$phenotype_id))
# [1] 12506
...
with(geneEqtl_methods, table(FDR_matrix < 0.01, FDR_tensor < 0.01))
#         TRUE
# FALSE  13577
# TRUE  319752
