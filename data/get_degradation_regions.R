...
# styler::style_file("get_degradation.R", transformers = biocthis::bioc_style())
...
## designate bigwigs
forwardBw = c(paste0("../preprocessed_data/Coverage/",
                     mdd_samples,".Forward.bw"),
              paste0("/dcl01/lieber/ajaffe/lab/zandiHyde_bipolar_rnaseq/preprocessed_data/Coverage/",
                     bip_samples,".Forward.bw"))
reverseBw = c(paste0("../preprocessed_data/Coverage/",
