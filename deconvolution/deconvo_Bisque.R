...
marker_stats %>%
  filter(rank_ratio <= 20, gene %in% rownames(rse_gene)) %>%
...
# 0.066 0.004 0.048 0.008 0.352 0.059 0.012 0.096 0.355
...
marker_table <- marker_stats2 %>% filter(rank_ratio <= 20) %>%
