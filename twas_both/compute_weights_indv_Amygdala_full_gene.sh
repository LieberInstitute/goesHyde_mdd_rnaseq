...
FILELIST=$(echo "/dcl01/lieber/ajaffe/lab/goesHyde_mdd_rnaseq/twas_both/Amygdala_gene/input_ids.txt")
...
## Define files
FILTBIM="/dcl01/lieber/ajaffe/lab/goesHyde_mdd_rnaseq/twas_both/Amygdala_gene/bim_files/Amygdala_gene_${FEATURENUM}/filtered_snps_Amygdala_gene_${FEATURENUM}"
