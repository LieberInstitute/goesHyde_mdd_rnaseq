...
modQsva = modJoint[,c(1:4,14,5:13)]
...
## run wgcna## changed min to 50, cut heright to 0.2 and deep split4
net = blockwiseModules(t(geneExprsClean), power = sftthresh1$powerEstimate,
                            networkType = "signed", minModuleSize = 50,corType="bicor",
                            reassignThreshold = 0, mergeCutHeight = 0.2, deepSplit = 4,
